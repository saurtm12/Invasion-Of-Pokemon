...
void AdvancedLogic::fileConfig(QString stops, QString buses) {
            qDebug () << "fileConfig";
            qDebug () << " ----check";
...
void AdvancedLogic::configChanged(QTime time, bool debug)
{
...
void AdvancedLogic::increaseTime()
{
...
void AdvancedLogic::addNewBuses()
{
...
void AdvancedLogic::createBus(std::shared_ptr<BusData> bus, QTime starttime)
{
...
std::map<QTime, std::weak_ptr<Stop> > AdvancedLogic::calculateStopTimes(std::map<QTime, std::shared_ptr<Stop> > &stops, QTime &starttime)
{
...
void AdvancedLogic::addNewPassengers(std::shared_ptr<Stop> stop, unsigned int no)
{
...
const int AdvancedLogic::TIME_SPEED = 10;
// time between updates in milliseconds
const int AdvancedLogic::UPDATE_INTERVAL_MS = 100;
